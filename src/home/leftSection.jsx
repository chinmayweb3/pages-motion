...
const LeftSection = () => {
  return (
    <div className="basis-[100%] xl:basis-[50%] h-screen flex justify-center flex-col">
      <p className="text-offGold font-orbitron font-bold tracking-[2px] text-[16px]">UI Developer</p>
      <h1 className=" text-[54px] lg:text-[72px] font-rajdhani font-black text-offBlack dark:text-offWhite d-mode leading-[1]">
